                                                                                                  ...
                                                                                                  Indent indent) const
{
  ...
  switch(m_PaddingMethod)
    {
  case PaddingMethodEnum::Zero:
    os << indent << "Padding Method: " << "Zero" << std::endl;
    break;
  case PaddingMethodEnum::Mirror:
    os << indent << "Padding Method: " << "Mirror" << std::endl;
    break;
  case PaddingMethodEnum::MirrorWithExponentialDecay:
    os << indent << "Padding Method: " << "MirrorWithExponentialDecay" << std::endl;
    break;
  default:
    os << indent << "Padding Method: " << "Unknown" << std::endl;
    break;
    }
